...
sudo rm -f /usr/bin/vfio-toggle.sh
...
sudo install -m 755 "${SCRIPT_DIR}/vfio-toggle.sh" /usr/bin/vfio-toggle.sh
...
echo "==> Done."
echo "    Binaries: /usr/bin/vfio-toggle.sh, /usr/bin/vfio-wrapper.sh"
echo "    Config:   /etc/vfio-toggle/vfio-toggle.conf"
echo ""
echo "Next steps:"
echo "  1. Edit /etc/vfio-toggle/vfio-toggle.conf to set your GPU_PCI_IDS"
echo "  2. Run: sudo vfio-toggle.sh list-devices"
echo "  3. Run: sudo vfio-toggle.sh status"
